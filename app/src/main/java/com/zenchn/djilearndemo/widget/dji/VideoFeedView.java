package com.zenchn.djilearndemo.widget.dji;
...
public class VideoFeedView extends TextureView implements SurfaceTextureListener {
    ...
    private void init() {
        ...
        subscription = timer.subscribe(new Action1() {
            ...
            public void call(Object o) {
                ...
                if (coverView != null) {
                    if (ellapsedTime > WAIT_TIME && !isMavic2Product()) {
    ...
    private static boolean isMavic2Product() {
        BaseProduct baseProduct = ApplicationKit.INSTANCE.getProductInstance();
        if (baseProduct != null) {
