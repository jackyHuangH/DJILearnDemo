...
object DateUtils {
    ...
    fun dateFormat(date: Date, pattern: String = SIMPLE_DATE_FORMAT_TEMPLATE, def: String? = null): String? {
...
internal val sdf: SimpleDateFormat by lazy {
    SimpleDateFormat(SIMPLE_DATE_FORMAT_TEMPLATE, Locale.CHINA)
}
...
fun Date.switch(switch: (Calendar.() -> Unit)): Date {
