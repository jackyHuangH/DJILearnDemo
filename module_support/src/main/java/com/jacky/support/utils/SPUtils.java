...
public class SPUtils {
    ...
    private SPUtils(final String spName) {
        if (sContext == null) {
            throw new IllegalStateException("u must init SPUtils first!");
        }
        sp = sContext.getSharedPreferences(spName, Context.MODE_PRIVATE);
    }
    ...
    private SPUtils(final String spName, final int mode) {
        ...
        sp = sContext.getSharedPreferences(spName, mode);
    }
