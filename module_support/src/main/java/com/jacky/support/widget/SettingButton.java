package com.jacky.support.widget;
...
import com.jacky.support.widget.factory.ViewFactory;
...
public class SettingButton extends ViewGroup {
    ...
    private void initAttr(Context context, AttributeSet attrs) {
        ...
        int defTextSize = DimenUtils.sp2px(16);
        ...
        mRightDrawableMargin = typedArray.getDimensionPixelOffset(R.styleable.SettingButton_setting_right_text_drawable_margin, DimenUtils.dp2px(10));

        int leftPadding = typedArray.getDimensionPixelOffset(R.styleable.SettingButton_setting_left_padding, DimenUtils.dp2px(15));
        int rightPadding = typedArray.getDimensionPixelOffset(R.styleable.SettingButton_setting_right_padding, DimenUtils.dp2px(15));
    ...
    private int measuredWidth(int measureSpec) {
        ...
        switch (specMode) {
            ...
            case MeasureSpec.EXACTLY:
                result = Math.min(specSize, DimenUtils.getScreenWidth());
                break;

            case MeasureSpec.AT_MOST:
            case MeasureSpec.UNSPECIFIED:
                result = DimenUtils.getScreenWidth();
                break;
        }
        return result;
    }
